...
class AutoEncoder():
    ...
    def __init__(self, code_size=320, img_dim=[16, 90, 1]):
        ...
        self.data_file_dir = '/home/satchel/m100_ws/src/ctrl_planning/training_data/TrainingDataFVs.txt'
    ...
    def save_model(self, model_dir='/home/satchel/m100_ws/src/ctrl_planning/scripts/AutoEncoder/weights/'):
    ...
    def load_model(self,
            encoder_fn='/home/satchel/m100_ws/src/ctrl_planning/scripts/AutoEncoder/weights/encoder_weights',
            encoder_decoder_fn='/home/satchel/m100_ws/src/ctrl_planning/scripts/AutoEncoder/weights/encoder_DECODER_weights'
            ):
